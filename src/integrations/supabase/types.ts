  ...
  public: {
    Tables: {
      anonymous_mappings: {
        ...
        Relationships: [
          {
            foreignKeyName: "anonymous_mappings_mentor_id_fkey"
            columns: ["mentor_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "anonymous_mappings_student_id_fkey"
            columns: ["student_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      chat_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "chat_messages_mentor_id_fkey"
            columns: ["mentor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      get_or_create_anonymous_number: {
